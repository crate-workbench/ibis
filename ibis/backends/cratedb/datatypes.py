...
from ibis.backends.base.sqlglot.datatypes import CrateDBType as SqlglotCrateDBType
...
class CrateDBType(AlchemyType):
    ...
    def to_ibis(cls, typ: sat.TypeEngine, nullable: bool = True) -> dt.DataType:
        ...
        #elif isinstance(typ, sat.UserDefinedType):
        #    return cls.to_ibis(typ.sqlType(), nullable=nullable)
        elif isinstance(typ, sat.UserDefinedType):
            print("typ:", typ, dir(typ))
            return
            return dt.Map(
    ...
    @classmethod
    def from_string(cls, type_string: str) -> CrateDBType:
        return SqlglotCrateDBType.from_string(type_string)
